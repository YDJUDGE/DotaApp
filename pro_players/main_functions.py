...
from pro_players.main_function import fetch_last_matches_simple, fetch_player_profile
...
def analyze_pro_player(account_id: int, match_limit: int = 100):
    ...
    matches = fetch_last_matches_simple(account_id, limit=match_limit)
    ...
    # Используем обновлённую функцию с именами и винрейтом
    ...
    result = {
        ...
        "transfer_price": transfer_price,
        "salary": salary,
        "top_heroes": top_heroes  # тут уже с именами и винрейтом
    }
