...
def get_roles_from_matches(matches):
    """
    Определяем роли игрока по матчам, основываясь на долях урона по героям, лечению и урону по зданиям.
    Возвращаем топ-2 роли.
    """
